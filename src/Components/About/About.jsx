                    ...
                    <div className="content-column col-lg-6 col-md-12 col-sm-12 order-2">
                        <div className="inner-column" style={{ direction: "rtl" }}>
                            ...
                            <div className="text" style={{ textAlign: "justify" }}>
                                ...
                                أسس الشركة فصيل العتابي، وأطلق نظام شبكات الألماس للحديد البارد والألمنيوم، الذي يمثل نقلة نوعية في عالم البناء الحديث. يعتمد النظام على آلات متطورة وفرق عمل ذات خبرة، مع التزام كامل بمعايير كود البناء السعودي.
